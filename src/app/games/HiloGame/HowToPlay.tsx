const HowToPlayCrash = () => (
  <div>
    <div className="line">
      HiLo is a fast paced game of exponential profits. The game is simple, pick
      your cards right and see your money multiply fast!
    </div>
    <br />
    ...
    <div className="line">King, Queen, Jack, 10, 9, 8, 7, 6, 5, 4, 3, 2, A</div>
    ...
    <div className="line">
      ...
      exceeded, the bet option button will state “Exceeds Max Win” and cannot be
      clicked. If both options exceed max win amount, player has to cash out to
    ...
    <div className="line">
      We use Provably Fair technology to resolve all our game results, hence the
      3 option cards are predetermined, and may not be altered before or during
      the game.
    </div>
    <br />
  </div>
